import time
import datetime
import adafruit_bmp280 # Dodano bmp280
import board
import busio
...
bmp280_I2C_ADDRESS = 0x76  # Domyślny adres MCP9808, zmień jeśli inny

# Inicjalizacja magistrali I2C i czujnika MCP9808
try:
    i2c = busio.I2C(board.SCL, board.SDA)
    sensor = adafruit_bmp280.BMP280(i2c, address=bmp280_I2C_ADDRESS)
    print(f"Pomyślnie zainicjowano czujnik MCP9808 pod adresem {hex(MCP9808_I2C_ADDRESS)}.")
except ValueError as e:
    print(f"Błąd inicjalizacji czujnika MCP9808: Nie znaleziono czujnika pod adresem {hex(bmp280_I2C_ADDRESS)}. Sprawdź połączenia i adres. {e}")
    sensor = None
